...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-ui-ux');?>
        
        <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/portfolio-wordpress-themes/');?>" target="_blank">
        <?php esc_html_e('SKT Portfolio Themes','skt-ui-ux'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
